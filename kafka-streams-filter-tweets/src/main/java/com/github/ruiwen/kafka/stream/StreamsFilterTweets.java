package com.github.ruiwen.kafka.stream;
...
public class StreamsFilterTweets {
    ...
    //use kafka streams to filter the twitter and send to kafka again
    ...
    private static Integer extractUserFollowersInTweet(String tweetJson) {
        //gson library
        try {
            return jsonParser.parse(tweetJson)  //parse json data and find my target condition
                    .getAsJsonObject()
                    .get("user")
                    .getAsJsonObject()
                    .get("followers_count")
